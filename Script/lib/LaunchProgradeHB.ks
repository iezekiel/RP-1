...
// Launches Rocket to a prograde tragectory set by pitch start variable with horizontal burn, similar to Explorer 1.
// v 1.2 (kOS 1.2.0)
...
LOCK STEERING TO HEADING(targetAzimith, 0).
UNTIL MAXTHRUST = 0 {
	timerUpdate().
	ACTIVATORS().
	WAIT 0.1.
